...
# --- Hotel Receptionist Persona (from backend/prompts.py) ---
# You can swap the AGENT_INSTRUCTION and SESSION_INSTRUCTION with the commented out
# versions below to switch to the hotel receptionist persona.
...
#     - Booking page with calender: http://localhost:51ītems/booking
#
